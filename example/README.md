...
To run the example, add orderly to your PATH and run ./run_example, feel free to experiment with
killing services and watch the restart logic handle the failures.
